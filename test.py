...
# create objects
extract_google = UrlExtractor(query='python classes explained easily')
extract_bing = UrlExtractor(query='python classes explained easily', search_engine='https://www.bing.com/')
extract_yahoo = UrlExtractor(query='python classes explained easily', search_engine='https://www.search.yahoo.com/')
